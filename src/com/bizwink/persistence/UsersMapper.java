...
public interface UsersMapper {
    ...
    int getUsersCountByParentOrgID(Map<String, Object> param);

    int getUsersCountByCustomer(BigDecimal siteid);

    List<Users> searchUsersByKeyword(Map<String, Object> param);       //搜索分页获取用户信息

    int searchUsersCountByKeyword(Map<String, Object> param);
