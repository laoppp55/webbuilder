    ...
    <table width="90%" border="0" align=center>
        ...
        <tr>
            <td height="40" align="left">
                <input type="radio" value="0" name="useArticleType" <%if(useArticleType == 0){%>checked<%}%>>引用文章链接&nbsp;&nbsp;
                <input type="radio" value="1" name="useArticleType" <%if(useArticleType == 1){%>checked<%}%>>引用文章内容
            </td>
        </tr>
        <tr>
            <td height="40" align="left">
