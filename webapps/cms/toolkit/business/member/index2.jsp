...
<%
    ...
    if(searchflag==1){
        ...
        currentlist = buserMgr.getBUserList(siteid,startrow,range,"");
        row = currentlist.size();
    }
%>
...
<table border=1 borderColorDark=#ffffec borderColorLight=#5e5e00 cellPadding=0 cellSpacing=0 width=100%>
    <tr bgcolor="#eeeeee" class=tine>
        ...
        <td align=center width="5%">USERID</td>
    ...
    <%
        ...
        for ( int i=0; i<row; i++){
            ...
            String createdate = formatDateAndTime.format(buser.getCreateDate());
    ...
    <tr bgcolor="#ffffff" class=line>
        ...
        <td align=center><%=(createdate==null?"":createdate)%></td>
        <%
            if(usertype == 5)
                out.println("<td align=center>普通用户</td>");
            else if (usertype == 1)
                out.println("<td align=center>内部用户</td>");
            else if (usertype == 2)
        ...
        <!--td align=center><a href="deleteUser.jsp?userid=<%=buser.getID()%>">删除</a></td-->
    </tr>
...
<center>
    ...
    <table width="770" border="0" cellspacing="0" cellpadding="4" bgcolor="#FFFFFF">
        <form method="post" action="index2.jsp" name="SearchForm">
                        ...
                        <tr bgcolor="#d4d4d4">
                            <td valign="top">
                                <table width="100%" border="0" cellpadding="4" cellspacing="1">
                                    ...
                                    <tr bgcolor="#FFFFFF">
                                        <td class="txt">手机号：&nbsp;
                                          <input type="text" name="mphone" class="input">
                                        </td>
