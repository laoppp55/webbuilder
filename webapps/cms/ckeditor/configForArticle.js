...
CKEDITOR.editorConfig = function( config ) {
	...
	config.toolbar_Article =[
       ...
       { name: 'insert', items : [ 'Image','Table','Bold','Italic','Underline','JustifyLeft','JustifyCenter','JustifyRight'] },
 	   { name: 'tools', items : [ 'InsertAttachment','uploadvideo','FormatHtml','WordToHtml','HisImages','About' ] }
    ];
	...
	config.extraPlugins='HisImages,InsertAttachment,uploadvideo,FormatHtml,WordToHtml';
};