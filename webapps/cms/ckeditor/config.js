...
CKEDITOR.editorConfig = function( config ) {
	...
	config.toolbar_Full =[
       { name: 'document', items : [ 'Source','-','model','metadatatag','Save','NewPage','DocProps','Preview','Print','-','Templates' ] },
       ...
       { name: 'insert', items : [ 'Image','Flash','Table','HorizontalRule','Smiley','SpecialChar','PageBreak','Iframe','InsertAttachment','uploadvideo','HisImages', ] },
	...
	//config.extraPlugins='model,myAddImage,code,FormatHtml,uploadimage';

    config.extraPlugins='model,metadatatag,InsertAttachment,uploadvideo,HisImages';
};