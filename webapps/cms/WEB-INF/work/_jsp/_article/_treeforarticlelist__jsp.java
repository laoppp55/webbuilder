...
public class _treeforarticlelist__jsp extends com.caucho.jsp.JavaPage
{
    ...
    do {
        ...
        for (i = 0; i < colTree.getNodeNum(); i++) {
            if (treeNodes[i].getLinkPointer() == currentID) {
                ...
                buf.append(name).append("\",\"addRelatedArticleRight.jsp?from="+from+"&param="+param+"&column=" + treeNodes[i].getId() + "\", \"cmsright\"));");
                buf.append("\n");
            }
        }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("article/treeforArticleList.jsp"), -3734642975955843519L, false);
    _caucho_depends.add(depend);
