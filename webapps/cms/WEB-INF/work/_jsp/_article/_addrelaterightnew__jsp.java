...
import com.bizwink.cms.news.relatedArticle;
...
public class _addrelaterightnew__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    if (doCreate) {
        ...
        errcode = extendMgr.addRelatedArticles(rlist, articleid,siteid);
    } else {
        errcode = 1;
    }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("article/addRelateRightnew.jsp"), 8135146032593828695L, false);
    _caucho_depends.add(depend);
