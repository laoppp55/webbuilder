...
public class _webtree__jsp extends com.caucho.jsp.JavaPage
{
    ...
    do {
        ...
        for(i=0;i<colTree.getNodeNum();i++) {
            if(treeNodes[i].getLinkPointer() == currentID) {
                ...
                buf.append(name).append("\",\"webmain.jsp?column="+treeNodes[i].getId()+"\", \"cmsright\"));");
                buf.append("\n");
            }
        }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("webedit/webtree.jsp"), -2021045895729968240L, false);
    _caucho_depends.add(depend);
