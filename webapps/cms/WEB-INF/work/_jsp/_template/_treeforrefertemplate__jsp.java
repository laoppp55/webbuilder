...
public class _treeforrefertemplate__jsp extends com.caucho.jsp.JavaPage
{
    ...
    do
    {
        ...
        for (i=0;i<colTree.getNodeNum();i++)
        {
            if (treeNodes[i].getLinkPointer() == currentID)
            {
                ...
                buf.append(name).append("\",\"referTemplateRight.jsp?column1="+treeNodes[i].getId()+"&column2="+columnID+"\", \"cmsright\"));");
                buf.append("\n");
            }
        }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("template/treeforReferTemplate.jsp"), 226639459293768873L, false);
    _caucho_depends.add(depend);
