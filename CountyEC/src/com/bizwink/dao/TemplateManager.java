    ...
    public int CreateTemplate(Template template){
        ...
        if (conn!=null) {
            try {
                ...
                DBUtil.setBigString("oracle", pstmt, 4, template.getCONTENT());
                pstmt.setString(4, "");
                ...
                pstmt.setInt(17, 0);
                pstmt.setInt(18,0);
                long modelID = dbUtil.getMainKeyID("Template");
                if (modelID > 0l) {
                ...
                if (retcode == 0) {
                    ...
                    for (int i = 0; i < queueList.size(); i++) {
                        ...
                        long id = dbUtil.getMainKeyID("PublishQueue");
                        if (id>0l) {
                            pstmt.setLong(11, id);
                            pstmt.executeUpdate();
                        } else {
    ...
    public int UpdateTemplate(Template template){
        ...
        if (conn!=null) {
            try {
                ...
                DBUtil.setBigString("oracle", pstmt, 3, template.getCONTENT());
