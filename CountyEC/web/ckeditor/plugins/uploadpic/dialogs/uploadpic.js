...
CKEDITOR.dialog.add( 'uploadpicDialog', function( editor ) {
	return {
		...
		onShow: function() {
			...
			if ( element )
				element = element.getAscendant( 'uploadpic', true );

			// Create a new <abbr> element if it does not exist.
			if ( !element || element.getName() != 'uploadpic' ) {
				element = editor.document.createElement( 'uploadpic' );
