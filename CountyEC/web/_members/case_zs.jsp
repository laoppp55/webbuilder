...
<%
    int samsiteid = ParamUtil.getIntParameter(request,"samsitetype",2991);      //2991;
    List<CmsTemplate> modellist = null;

    ApplicationContext appContext = SpringInit.getApplicationContext();
    if (appContext!=null) {
        UsersService ds = (UsersService)appContext.getBean("UsersService");
        modellist = ds.getTemplates(BigDecimal.valueOf(samsiteid));
    }
    ...
    /*try {
        ...
        modellist = (ArrayList)call.invoke(new Object[] {samsiteid});
...
<div class="box_mb">
    ...
    <div class="mb_pic">
        <form name="select_model" onsubmit="javascript:select_the_template(select_model)">
            ...
            <div class="mb_pic_1">
                <%if (samsiteid == 2991) {%>
                <p><a href="javascript:openwin('http://njy01.coosite.com/index<%=ct.getTEMPNUM()%>.shtml')"><img src="images/njy/20151229_0<%=(ii+1)%>.jpg" /></a></p>
                <% } else if(samsiteid == 4592) {%>
                <p><a href="javascript:openwin('http://njy01.coosite.com/index<%=ct.getTEMPNUM()%>.shtml')"><img src="images/mlxc/t<%=(ii+1)%>.jpg" width="340" height="313" /></a></p>
                <% } else if (samsiteid == 2992) {%>
                <p><a href="javascript:openwin('http://njy01.coosite.com/index<%=ct.getTEMPNUM()%>.shtml')"><img src="images/czy/t<%=(ii+1)%>.jpg" /></a></p>
                <% } else if (samsiteid == 2993) {%>
                <p><a href="javascript:openwin('http://njy01.coosite.com/index<%=ct.getTEMPNUM()%>.shtml')"><img src="images/jq/t<%=(ii+1)%>.jpg" /></a></p>
                <%}%>
